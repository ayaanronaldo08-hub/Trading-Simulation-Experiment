...
from data.logger import log #imports the logging function from logger file
import random #imports random module
import time #imports time module
import os # NEW: Imports the os module to interact with the operating system/terminal size
